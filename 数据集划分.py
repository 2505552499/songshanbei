...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'D:\数据集1\dent\images', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'D:\数据集1\dent\labels', help='txt path dir')
    parser.add_argument('--save-dir', default=r'D:\数据集1\dent\split', type=str, help='save dir')
